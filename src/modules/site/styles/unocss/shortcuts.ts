export const shortcuts = {
    ...
    "text-menu-accent": "text-menu-active underline decoration-1 underline-offset-4",
    "mobile-full-bleed": " <md:w-[calc(100%+2rem)] <md:max-w-none <md:-ml-4 ",
    "menu-item-hover":
        "hover:bg-menu transition-linear hover:text-menu-active hover:underline hover:decoration-1 hover:underline-offset-4",
    "content-width": "md:w-168 <md:mx-4 mx-auto",
    "text-link":
