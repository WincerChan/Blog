...
const Home = () => {
  ...
  return (
    <MainLayout page={recentPosts[0]}>
      ...
      <A inactiveClass='' activeClass='' class=":: transition <md:mx-4 duration-200 ease-linear text-[var(--menu-hover-text)] hover:text-[var(--menu-hover-bg)] text-lg px-.5 text-link " href="/archives/">查看更多文章</A>
    </MainLayout>
  );
}
