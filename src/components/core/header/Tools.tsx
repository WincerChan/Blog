    ...
    return (
        <ul class="flex">
            <li class="menu-hover-transition">
                <a onClick={() => globalStore.trackEvent("Menu CTR", { props: { type: "search" } })} href={`/search${locale() == "zh-CN" ? "" : "-en"}/`} title="Search" class=":: h-full px-3 md:px-6 flex items-center ">
                    <IconSearch width={20} height={20} class=":: md:w-6 md:h-6 " />
                </a>
            </li>
            <li class="menu-hover-transition">
                <a onClick={() => globalStore.trackEvent("Menu CTR", { props: { type: "rss" } })} href="/atom.xml" target="_blank" title="RSS" class=":: h-full px-3 md:px-6 flex items-center ">
