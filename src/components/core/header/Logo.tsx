...
const Logo = () => {
    return (
        <A href="/" activeClass="" class=":: flex items-center justify-center bg-menuHover trans-linear cursor-pointer space-x-3 h-menu <sm:h-14 " >
            <img src="https://ae01.alicdn.com/kf/HTB1DdGHXizxK1RjSspj763S.pXax.png" alt="avatar" id="avatar" width={32} height={32} class=":: rounded-36 sm:w-9 sm:h-9 shadow-round " />
