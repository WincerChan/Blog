...
Personal blog built with SolidStart + Velite. The default branch (`master`) contains the current Velite-based codebase. The legacy Hugo + SolidStart implementation is preserved in `legacy/hugo-solidstart`.
...
- Optional encrypted posts (encrypted in build output)
